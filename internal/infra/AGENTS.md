...
Adaptadores técnicos: Postgres, JWT, runner de migrations. Infra não tem
regra de negócio — sabe conectar, executar e fechar.
...
- Postgres e JWT são **fatais**: erro no boot derruba o processo.
  Dependências futuras degradáveis (Redis, ClickHouse) devolvem cliente nulo
  com log `[DEGRADADO]`, e o consumidor é obrigado a tratar a ausência.
