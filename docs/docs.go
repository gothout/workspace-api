...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/application/licensing/minhas-aplicacoes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/aplicacoes.MinhasAplicacoesResponseDto"
                        }
                    },
                    "400": {
        ...
        "/api/domain/identidade/users/{uuid}/senha": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Senha atual (se for o próprio) e nova senha",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.AlterarSenhaRequestDto"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "Senha atual incorreta ou operador não identificado",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    },
                    "403": {
                        "description": "Hierarquia insuficiente",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/pagination.Response-modulo_ModuloResponseDto"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modulo.CreateModuloRequestDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/modulo.ModuloResponseDto"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/domain/licensing/modulos/{uuid}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Módulo com licenças vivas",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modulo.UpdateModuloRequestDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/domain/licensing/organizations/{organization_uuid}/licencas": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/licenca.LicencaResponseDto"
                            }
                        }
                    },
                    "400": {
                    ...
                    "403": {
                        "description": "Organization alheia sem permissão de plataforma",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "UUID da organization alvo",
                        "name": "organization_uuid",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Módulo a licenciar",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/licenca.AtribuirLicencaRequestDto"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Organization ou módulo inexistente",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    },
                    "409": {
                        "description": "Licença já concedida",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    }
        ...
        "/api/domain/licensing/organizations/{organization_uuid}/licencas/{uuid}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/domain/licensing/workspaces/{workspace_uuid}/modulos": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "UUID do workspace alvo",
                        "name": "workspace_uuid",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/ativacao.AtivacaoResponseDto"
                            }
                        }
                    },
                    "400": {
                    ...
                    "404": {
                        "description": "Workspace fora da organization",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Módulo a ativar",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ativacao.AtivarModuloRequestDto"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Workspace ou módulo inexistente",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    },
                    "409": {
                        "description": "Já ativado",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    },
                    "422": {
                        "description": "Sem licença do módulo",
                        "schema": {
                            "$ref": "#/definitions/rest_err.RestErr"
                        }
                    }
        ...
        "/api/domain/licensing/workspaces/{workspace_uuid}/modulos/{uuid}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/domain/todolist/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Módulo ativo (todolist)",
                        "name": "Application",
                        "in": "header",
                        "required": true
                    },
                    ...
                    {
                        "type": "boolean",
                        "description": "Filtro por conclusão",
                        "name": "concluida",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/pagination.Response-tarefa_TarefaResponseDto"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tarefa.CreateTarefaRequestDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/tarefa.TarefaResponseDto"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/domain/todolist/tasks/{uuid}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tarefa.UpdateTarefaRequestDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "aplicacoes.MinhasAplicacoesResponseDto": {
            "type": "object",
            "properties": {
                "aplicacoes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/workspace-api_internal_licensing_model_ativacao.AplicacaoDisponivelDto"
                    }
                }
            }
        },
        "ativacao.AtivacaoResponseDto": {
            "type": "object",
            "properties": {
                "ativado_por": {
                    "type": "string"
        ...
        "ativacao.AtivarModuloRequestDto": {
            "type": "object",
            "required": [
                "modulo_slug"
            ],
        ...
        "licenca.AtribuirLicencaRequestDto": {
            "type": "object",
            "required": [
                "modulo_slug"
            ],
        ...
        "pagination.Response-modulo_ModuloResponseDto": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "pagination.Response-tarefa_TarefaResponseDto": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "workspace-api_internal_licensing_model_ativacao.AplicacaoDisponivelDto": {
            "type": "object",
            "properties": {
                "nome": {
                    "type": "string"
